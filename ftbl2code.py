...
source("/home/sokol/R/Rtools/opt_cumo_tools.R");
...
""" % {
    ...
    rAb=C13_ftbl.rcumo_sys(netan, measures);
    ...
    netan2Abcumo_f(rAb["A"], rAb["b"],
        netan["vrcumo"], netan["input"], ff, fwrv2i, rcumo2i, "fwrv2rAbcumo");
    # and for complete cumomer systems
    netan2Abcumo_f(netan["cumo_sys"]["A"], netan["cumo_sys"]["b"],
        netan["vcumo"], netan["input"], ff, fwrv2i, cumo2i, "fwrv2Abcumo");
...
"""%{
    ...
    "ncol": (no_mcumo+1),
    "imeas": join(", ", trd(o_mcumos,cumo2i,a="")),
    "irmeas": join(", ", trd(o_mcumos,rcumo2i,a="")),
