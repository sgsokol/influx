#!/usr/bin/env python
"""Simulate labeling propagation in a pulse experiment
and optimize free fluxes of a given static metabolic network to fit
13C data defined in an FTBL and a time_curse file."
"""
...
parser.add_option("--cupp", type="float",
    help="upper limit for metabolite pools")
...
parser.add_option("--clowp", type="float",
    help="lower limit for metabolite pools. Must be positive.")
...
try:
    ...
    pycmd=["python", os.path.join(direx, "ftbl2labprop.py")] + opt4py
    #print(pycmd)
